...
<div className="card text-center bg-success">
    <div className="border container bg-light my-3">    
...
<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Fresh Grocery LTD
...
<ul>
    ...
    <li>Reproduce, duplicate or copy material from Fresh Grocery LTD</li>
    <li>Redistribute content from Fresh Grocery LTD</li>
</ul>
...
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
    of the website. Fresh Grocery does not filter, edit, publish or review Comments prior to their presence on the
    website. Comments do not reflect the views and opinions of Fresh Grocery,its agents and/or affiliates. Comments
    reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
    applicable laws, Fresh Grocery shall not be liable for the Comments or for any liability, damages or expenses caused
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Fresh Grocery; and
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to Fresh Grocery. Please include your name, your organization name, contact
